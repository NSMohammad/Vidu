...
//    private func createSocket(token: String, session: String) {
...
//        socketService = WebSocketService(baseUrl: token, sessionName: session, participantName: participantName, peersManager: self.peersService, openViduToken: token)
    ...
    func createMediaSenders() {
        ...
        print("e1- \(peersService.localPeer)")
